...
namespace MechHumanlikes
{
    ...
    static class MHC_Textures
    {
        ...
        public static readonly Texture2D MechDronePawnTypeRestricted = ContentFinder<Texture2D>.Get("UI/Icons/Dialogs/MHC_MechDronePawnTypeRestricted");
        public static readonly Texture2D MechSapientPawnTypeRestricted = ContentFinder<Texture2D>.Get("UI/Icons/Dialogs/MHC_MechSapientPawnTypeRestricted");
        public static readonly Texture2D OrganicPawnTypeRestricted = ContentFinder<Texture2D>.Get("UI/Icons/Dialogs/MHC_OrganicPawnTypeRestricted");
    }
}